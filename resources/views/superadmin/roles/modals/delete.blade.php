...
<div class="modal fade" id="deleteZone{{$role->id}}" tabindex="-1" role="dialog" aria-labelledby="modal-block-fadein" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form method="POST" id="delZone{{ $role->id }}" action="{{route('superadmin.roles.destroy',  $role->id)}}">
                @csrf
                {{method_field('delete')}}
