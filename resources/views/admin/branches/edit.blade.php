...
<div class="content">
    ...
    <form class="js-validation" autocomplete="off" action="{{ route('branches.update', $branch->id) }}" method="POST">
        @csrf
        @method('put')
                ...
                <div class="row items-push">
                    ...
                    <div class="col-lg-8 col-xl-5">
                        <div class="form-group">
                            ...
                            <input type="text" placeholder="Branch Name" value="{{ $branch->branch_name }}" id="demo-hor-inputemail"
                        ...
                        <div class="form-group">
                            ...
                            class="form-control" name="branch_code" value="{{ $branch->branch_code }}">
                            @error('branch_code')
                                <span class="text-danger"> {{ $message }} </span>
                            @enderror
                        ...
                        <div class="form-group">
                            ...
                            class="form-control"
                            name="branch_manager_name" value="{{old('branch_manager_name', $branch->branch_manager_name)}}">
                        ...
                        <div class="form-group">
                            ...
                            class="form-control"
                            name="branch_contact_no" value="{{old('branch_contact_no', $branch->branch_contact_no)}}">
                        ...
                        <div class="form-group">
                            ...
                            class="form-control"
                            name="branch_it_support_name" value="{{old('branch_it_support_name', $branch->branch_it_support_name)}}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" placeholder="Branch IT Support No" id="demo-hor-inputemail"
                                               class="form-control"
                                               name="branch_it_support_no" value="{{old('branch_it_support_no', $branch->branch_it_support_no)}}">
