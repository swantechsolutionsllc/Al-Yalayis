...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('assets/tree/demo/css/jquery.orgchart.css') }}">
  <link rel="stylesheet" href="{{ asset('assets/tree/demo/css/style.css')}}">
  <style type="text/css">
...
<body>
  ...
  <script type="text/javascript" src="{{ asset('assets/tree/demo/js/jquery.min.js')}}"></script>
  <script type="text/javascript" src="{{ asset('assets/tree/demo/js/jquery.orgchart.js')}}"></script>
  <script type="text/javascript">
    var zones = '<?php echo json_encode($data); ?>';
