...
@section('pageTitle', 'Create Counter Settings')
@section('styles')
...
<div class="content">
    ...
    <form class="form-horizontal" method="POST" action="{{route('cd-settings.store')}}" enctype="multipart/form-data" id="myform">
        @csrf
        
        <div class="block block-rounded">
            <div class="block-content block-content-full">
                <!-- Regular -->
                <h2 class="content-heading border-bottom mb-4 pb-2">Counter Display:</h2>
                    ...
                    <div class="row items-push">
                        <div class="form-group col-md-4">
                            ...
                            <div class="js-colorpicker input-group" data-format="hex">
                                <input type="text" class="form-control" id="example-colorpicker2 ticket_color" name="ticket_color" required>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <div class="input-group">
                                <input type="number" min="0" class="form-control" id="example-group1-input2 ticket_font_size" name="ticket_font_size" required>
                                <div class="input-group-append">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <div class="js-colorpicker input-group" data-format="hex">
                                <input type="text" class="form-control" id="example-colorpicker2 ticket_blinking_color" name="ticket_blinking_color" required>
                                <div class="input-group-append">
                                    <span class="input-group-text colorpicker-input-addon">
                                        <i></i>
                                    </span>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="row items-push">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <div class="js-colorpicker input-group" data-format="hex">
                                <input type="text" class="form-control" id="example-colorpicker2 counter_number_color" name="counter_number_color" required>
                                <div class="input-group-append">
                                    <span class="input-group-text colorpicker-input-addon">
                                        <i></i>
                                    </span>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <div class="input-group">
                                <input type="number" min="0" class="form-control" id="example-group1-input2 counter_number_font_size" name="counter_number_font_size" required>
                                <div class="input-group-append">
                                    <span class="input-group-text">
                                        px
                                    </span>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <div class="js-colorpicker input-group" data-format="hex">
                            <input type="text" class="form-control" id="example-colorpicker2 service_name_color" name="service_name_color" required>
                            <div class="input-group-append">
                                <span class="input-group-text colorpicker-input-addon">
                                    <i></i>
                                </span>
                    ...
                    <div class="form-group col-md-4">
                            ...
                            <div class="input-group">
                                <input type="number" min="0" class="form-control" id="example-group1-input2 service_font_size" name="service_font_size" required>
                                <div class="input-group-append">
                                    <span class="input-group-text">
                                        px
                                    </span>
