...
<div class="modal fade" id="deleteZone{{$zone->id}}" tabindex="-1" role="dialog" aria-labelledby="modal-block-fadein" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form method="POST" id="delZone{{ $zone->id }}" action="{{url('zones/' . $zone->id)}}">
                @csrf
                {{method_field('delete')}}
