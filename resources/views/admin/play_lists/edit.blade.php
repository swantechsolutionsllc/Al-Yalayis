                   ...
                   <div class="content-block" style="">
                        ...
                        <form method="post" action="{{route('play-lists.update', $playList)}}">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-md-4  edit-btn-div" >
                                    <div class="form-group playlists">
                                        <a href="{{ url('device-templates/edit/'.$playList->device_template_data_id)}}" id="edit-template_button" class="btn bg-dark text-white">Edit Template</a>
...
@section('js')
    <script>
        ...
        $("#template_id").change(function(){
            var id = $(this).val();
            var editUrl = url+'device-templates/edit/'+id;
            $.ajax({
                url:"{{url('get-template-assets')}}/"+id+"?playlist_id={{$playList->id}}",
                type:'get',
                success:function(data){
                   $("#assets").html(data);
                   $("#edit-template_button").attr('href', editUrl);
                }
            });
