                        ...
                        <div class="container">
                            ...
                            @endif
                                <div class="{{$template->device_templates->quebox_required==1?'col-lg-9':'col-lg-12'}}">
                                    <div class="card mt-4">
                                        <video width="50%" height="50%"  id="myVideo1" controls autoplay style="float:left;">
                                            <source src="{{asset($template->videosbox1[0]->asset_url)}}" id="mp4Source" type="video/mp4">
                                            Your browser does not support the video tag.
                                        </video>
                                        <video width="50%" height="50%"  id="myVideo2" controls autoplay style="float:right;">
                                            <source src="{{asset($template->videosbox2[0]->asset_url)}}" id="mp4Source" type="video/mp4">
                                            Your browser does not support the video tag.
                                        </video>
                                    </div>
                                    <div class="card mt-4">
                                        <video width="50%" height="50%"  id="myVideo3" controls autoplay style="float:left;">
                                            <source src="{{asset($template->videosbox3[0]->asset_url)}}" id="mp4Source" type="video/mp4">
                                            Your browser does not support the video tag.
                                        </video>
                                        <video width="50%" height="50%"  id="myVideo4" controls autoplay style="float:right;">
                                            <source src="{{asset($template->videosbox4[0]->asset_url)}}" id="mp4Source" type="video/mp4">
                                            Your browser does not support the video tag.
                                        </video>
                                    </div>
                                </div>
