                        ...
                        <div class="container">
                            ...
                            @endif
                                <div class="{{$template->device_templates->quebox_required==1?'col-lg-9':'col-lg-12'}}">
                                    <div class="card mt-4">
                                        <img width="50%" height="50%"   style="float:left;" src="{{asset($template->imagesbox1[0]->asset_url)}}" >
                                        <img width="50%" height="50%"   style="float:right;" src="{{asset($template->imagesbox2[0]->asset_url)}}" >
                                    </div>
                                    <div class="card mt-4">
                                        <img width="50%" height="50%"   style="float:left;" src="{{asset($template->imagesbox3[0]->asset_url)}}" >
                                        <img width="50%" height="50%"   style="float:right;" src="{{asset($template->imagesbox4[0]->asset_url)}}" >
                                    </div>
                                </div>
