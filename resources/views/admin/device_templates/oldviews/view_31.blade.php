                        ...
                        <div class="container">
                            ...
                            @endif
                                <div class="{{$template->device_templates->quebox_required==1?'col-lg-9':'col-lg-12'}}">
                                    <div class="card mt-4">
                                       <img width="50%" height="50%" src="{{asset($template->imagesbox1[0]->asset_url)}}" style="float: left;">
                                       <img width="50%" height="50%" src="{{asset($template->imagesbox2[0]->asset_url)}}" style="float: right;">
                                        
                                    </div>
                                    <div class="card mt-4">
                                        
                                         <video width="100%" height="50%"  id="myVideo1" controls autoplay style="float:left;">
