                            ...
                            <div class="{{$template->device_templates->quebox_required==1?'col-lg-9':'col-lg-12'}}">
                                <div class="row">
                                    <div class="col-sm-6 no-padding">
                                        <img width="100%" height="50%"   class="border" src="{{asset($template->imagesbox1[0]->asset_url)}}" >
                                    </div>
                                    <div class="col-sm-6 no-padding">
                                         <img width="100%" height="50%"   class="border" src="{{asset($template->imagesbox2[0]->asset_url)}}" >
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-6 no-padding" >
                                          <img width="100%" height="50%"   class="border" src="{{asset($template->imagesbox3[0]->asset_url)}}" >
                                    </div>
                                    <div class="col-sm-6 no-padding">
                                         <img width="100%" height="50%"   class="border" src="{{asset($template->imagesbox4[0]->asset_url)}}" >
                                    </div>
                                </div>
                            </div>
                        </div>   
