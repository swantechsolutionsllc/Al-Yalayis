                    ...
                    <div class="panel-body">
                        ...
                        <div class="row" style="border: 5px solid #fff;">
                            ...
                            <div class="{{$template->device_templates->quebox_required==1?'col-lg-9':'col-lg-12'}}">
                                <video width="100%" height="85%"  id="myVideo" controls autoplay style="background: #e8e8d3; border: 5px solid #c1c1c1">
                                            <source src="{{asset($template->videosbox1[0]->asset_url)}}" id="mp4Source" type="video/mp4">
                                            Your browser does not support the video tag.
                                </video>
                                @if($template->device_templates->current_queue)
                            @include('admin.device_templates.view.current_queue')
                        @endif 
                            </div>
