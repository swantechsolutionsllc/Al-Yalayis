                            ...
                            <div class="{{$template->device_templates->quebox_required==1?'col-lg-9':'col-lg-12'}}">
                                <div class="row">
                                    <div class="col-sm-6 no-padding">
                                        <video width="100%" height="50%"  id="myVideo1" controls autoplay class="border">
                                            <source src="{{asset($template->videosbox1[0]->asset_url)}}" id="mp4Source" type="video/mp4">
                                            Your browser does not support the video tag.
                                        </video>
                                    </div>
                                    <div class="col-sm-6 no-padding">
                                        <video width="100%" height="50%"  id="myVideo2" controls autoplay class="border">
                                ...
                                <div class="row">
                                    <div class="col-sm-6 no-padding" >
                                         <video width="100%" height="50%"  id="myVideo3" controls autoplay class="border">
                                            <source src="{{asset($template->videosbox3[0]->asset_url)}}" id="mp4Source" type="video/mp4">
                                            Your browser does not support the video tag.
                                        </video>
                                    </div>
                                    <div class="col-sm-6 no-padding">
                                        <video width="100%" height="50%"  id="myVideo4" controls autoplay class="border">
